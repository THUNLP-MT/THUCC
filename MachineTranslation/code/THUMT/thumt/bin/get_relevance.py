...
import thumt.utils.visualize as visualize
...
def main(args):
    ...
    # Load configs
    model_cls_list = [models.get_model(model, lrp=True) for model in args.models]
        ...
        with tf.train.MonitoredSession(session_creator=sess_creator) as sess:
            ...
            while not sess.should_stop():
                ...
                for i in range(src_seq.shape[0]):
                    ...
                    #visualize.visualize(src, trg, rlv_info["result"], params)
                    print('src:', src)
                    print('trg:', trg)
